  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/googlereviews",
        formData,
        {
  ...
  return (
    <div className="min-h-screen bg-[#681024] flex items-center justify-center px-4">
      <div className="w-full max-w-2xl bg-white shadow-lg rounded-lg p-8">
        <h1 className="text-2xl font-semibold text-gray-800 mb-4">Google Reviews</h1>
            ...
            {errors.nullvalues && (
              <div className="=text-black">
                ...
                <ul className="space-y-2">
                  ...
                  {errors.nullvalues.nullreviewid && (
                    <div>
                      <strong>Null Names:</strong>
                      <ul>
                        {errors.nullvalues.nullreviewid.map((name, index) => (
                  ...
                  {errors.nullvalues.nullreviewerprofile && (
                    <div>
                      <strong>Null Addresses:</strong>
                      <ul>
                        {errors.nullvalues.nullreviewerprofile.map((address, index) => (
